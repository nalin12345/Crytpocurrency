...
image = Image.open(r'C:\Users\Nalin\Desktop\StreamLit\logo.jpg')

st.image(image,width=500)

st.title('Crypto Price App')
st.markdown("""
This app retrieves cryptocurrency prices for the top 100 cryptocurrency from the **CoinMarketcCap**!
""")
...
def load_data():
	...
	df = pd.DataFrame(columns=['coin_name', 'coin_symbol', 'market_cap', 'percent_change_1h', 'percent_change_24h', 'percent_change_7d', 'price', 'volumne_24h'])
...
df_change = pd.concat([df_coins.coin_symbol, df_coins.percent_change_1h, df_coins.percent_change_7d, df_coins.percent_change_24h], axis=1)
...
if percent_timeframe == '7d':
	...
	plt.subplots_adjust(top=1, button=0)
